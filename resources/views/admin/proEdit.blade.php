        ...
        <div class="form form-horizontal" id="form-user-add">
            <div class="row cl">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text" value="{{$res->info}}" placeholder="" id="proname" name="product-category-name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">文字说明：</label>
                <div class="formControls col-xs-6 col-sm-6">
                    <textarea id="content" style="height: 300px" cols="" rows="" class="textarea"  placeholder="">{{$content->content}}</textarea>
            ...
            <div class="row cl">
                <div class="col-9 col-offset-2">
                    <input class="btn btn-primary radius" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" onclick="sendChange({{$res->id}})" id="res">
                </div>
            </div>
        </div>
